...
public class DataUtil {
	...
	private static Logger log = LogManager.getLogger(DataUtil.class.getClass()); //Write in applog.txt

	public static void checkExecution(String testSuiteName, String testCaseName, String dataRunMode,
			ExcelReader excel) {

		log.info("DataUtil: checkExecution.... -testSuiteName: " + testSuiteName + " -testCaseName: " + testCaseName + " -dataRunMode: " + dataRunMode);
	...
	public static boolean isSuiteRunnable(String suiteName) {
		...
		log.info("DataUtil: isSuiteRunnable... " + suiteName);
	...
	public static boolean isTestRunnable(String testCaseName, ExcelReader excel) {
		...
		log.info("DataUtil: isTestRunnable... " + testCaseName);
	...
	public static Object[][] getData(String testCase, ExcelReader excel) {
		...
		log.info("DataUtil: getData... " + testCase);
